...
#icon
image_icon = PhotoImage(file="iconpng.png")
...
#translator button
translate = Button(root, text="Translate", font="Roboto 15 bold italic", activebackground="grey", cursor="hand2", bd=5, bg="grey", fg="white", command=translate_now)
